...
import com.anishsneh.microweaver.service.core.MicroweaverCoreServiceApplication;
import com.anishsneh.microweaver.service.core.util.ApiContants;
import com.anishsneh.microweaver.service.core.util.ApiDocsInfo;
...
public class ApiDocsConfiguration {
    ...
    public Docket documentation() {
        return new Docket(DocumentationType.SWAGGER_2)
          .select()
            .apis(RequestHandlerSelectors.basePackage(MicroweaverCoreServiceApplication.class.getPackage().getName()))
